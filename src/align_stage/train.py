...
from loss import dpo_loss, exact_loss, fpo_loss
...
def parse_args():
    ...
    parser.add_argument("--wandb_name",
                        type=str,
                        default='temp')
    parser.add_argument("--wandb_log_every_step",
                        type=int,
                        default=10)
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if "dpo" in args.loss_type:
                ...
                loss = fpo_loss(logits / args.temp,
                                    outputs.logits / args.temp,
                                    batch["attention_mask"],
                                    batch["input_ids"],
                                    prompt_lens,
            ...
            if torch.distributed.get_rank() == 0:
                ...
                if step % args.wandb_log_every_step == 0:
